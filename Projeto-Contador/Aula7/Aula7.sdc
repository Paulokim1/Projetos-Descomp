...
# IOs of the top-level block are called port,
# IOs of the subblocks are called pin.
# So get_ports and get_pins commands must be used accordingly.
# The signals other than the IOs are called net.
...
#create_generated_clock -add -source CLOCK_50 -divide_by 62500 -name CLK_400HZ  [get_pins {CLK_400HZq}]
#create_generated_clock -add -source [get_pins {CLK_400HZq}] -name CLK_10HZ  [get_pins {CLK_10HZq}]
#set_false_path -from [get_pins {CLK_400HZq}] -to [get_pins {CLK_10HZd}]
